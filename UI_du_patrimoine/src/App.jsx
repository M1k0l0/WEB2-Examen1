...
import Flux from "../../Patrimoine/models/possessions/Flux";
import Possession from "../../Patrimoine/models/possessions/Possession";
import data from "../../Patrimoine/data/data.json";
    ...
    <>
      ...
      <Container className="containe-all">
        <div className="patrimoine">
          <h2>Select a date</h2>
          <Form.Control type="date" value={initialDate} onChange={handleChangeDate} />
